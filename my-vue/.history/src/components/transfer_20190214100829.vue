                ...
                <div class="transfer-main">
                  ...
                  <div class="el-transfer-panel__body">
                    <div class="el-transfer-panel__filter el-input el-input--small el-input--prefix">
                        <input type="text" autocomplete="off" placeholder="请输入城市拼音" class="el-input__inner">
                        <span class="el-input__prefix">
                            <i class="el-input__icon el-icon-search"></i>
                        </span>
                    </div>
                    <div role="group" aria-label="checkbox-group" class="el-checkbox-group el-transfer-panel__list is-filterable" style="">
                        <label role="checkbox" class="el-checkbox el-transfer-panel__item">
                            ...
                            <span class="el-checkbox__label"><span>上海</span></span>
                        </label>
                    </div>
