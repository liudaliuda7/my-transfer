                  ...
                  <div class="el-transfer-panel__item">
                    ...
                    <label role="checkbox" class="el-checkbox el-transfer-panel__item is-checked" aria-checked="true">
                      <span aria-checked="mixed" class="el-checkbox__input is-checked">
                        <span class="el-checkbox__inner"></span><input type="checkbox" aria-hidden="true" class="el-checkbox__original" value="0"></span><span class="el-checkbox__label"><span>上海</span><!----></span></label>
                  </div>
                  <slot name="right-footer"></slot>
                </div>
              </div>
